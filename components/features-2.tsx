    ...
    <section className="py-16 md:py-32">
      <div className="@container mx-auto max-w-5xl px-6">
        <div className="text-center">
          ...
          <p className="mt-4">
            Flawless writing, zero effort required - eliminate typos and improve
        ...
        <div className="@min-4xl:max-w-full @min-4xl:grid-cols-3 mx-auto mt-8 grid max-w-sm gap-6 [--color-background:var(--color-muted)] [--color-card:var(--color-muted)] *:text-center md:mt-16 dark:[--color-muted:var(--color-zinc-900)]">
          ...
          <Card className="group border-0 shadow-none bg-background">
            ...
            <CardContent>
              ...
              Customize every aspect of your content transformation
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="group border-0 shadow-none bg-background">
            ...
            <CardContent>
              <p className="mt-3 text-sm">
              Cutting-edge technology transforms your content instantly and intelligently
              </p>
            </CardContent>
          </Card>
        </div>
...
const CardDecorator = ({ children }: { children: ReactNode }) => (
  <div className="relative bg-background mx-auto size-36 duration-200 [--color-border:color-mix(in_oklab,var(--color-zinc-950)10%,transparent)] group-hover:[--color-border:color-mix(in_oklab,var(--color-zinc-950)20%,transparent)] dark:[--color-border:color-mix(in_oklab,var(--color-white)15%,transparent)] dark:group-hover:bg-white/5 dark:group-hover:[--color-border:color-mix(in_oklab,var(--color-white)20%,transparent)]">
    <div
      aria-hidden
